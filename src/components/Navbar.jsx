      ...
      <div className='flex items-center gap-4'>
        {
          ...
          : <button onClick={()=>navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-full hover:bg-primary/80        transition-all duration-300 font-light hidden md:block'>Create Account</button>
        }
